...
function cleanBasicHtml(html = '', _options = {}) {
  ...
  let cleanHtml = html.replace(/<br\s?\/?>/g, ' ').replace(/(\s|&nbsp;){2,}/g, ' ').trim().replace(/^&nbsp;|&nbsp$/g, '').trim(); // remove any elements that have a blank textContent
